/*dimensions and movement distances in centimeters*/
      ...
      case 2: // moveTo:x0:y0:delay/pulse width
        //BLUE
        {
          ...
          */
          ...
          Serial.print("xLocinuSteps: "); Serial.println(xLocinuSteps);
          Serial.print("yLocinuSteps: "); Serial.println(yLocinuSteps);
          Serial.print("locationInit: "); Serial.print(location[0]); Serial.print(" "); Serial.println(location[1]);
