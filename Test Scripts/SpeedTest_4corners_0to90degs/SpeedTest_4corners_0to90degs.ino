...
/*for small bot, smallest speed for speed model should be 20 us*/
...
#define xMin 6 //problems with switch - troubleshooting - changed from 2 to 6 - problem still occurred, next thing to try is changing wiring and adding new microswitch
#define xMax 3
#define yMin 4
#define yMax 5
/*pins for RGB LED*/
  ...
  if (val != NULL) { /*if val is not empty*/
    ...
    switch ((int) *command) { /*switch case based on first command*/
      ...
      case 5: //speedModelFit:delayi:delayf:ddelay:angleTrials
         //modified speed data collection
        {
